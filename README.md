...
1. Enroll in the relevant OpenLegacy LearnUpon course for your target system (CICS or IBM i).
2. Clone or download this repository:
   ```bash
   git clone https://github.com/openlegacy/OpenLegacy-Training-Materials.git
   ```
3. Open the folder that matches the course module you are taking.
4. Follow the instructions in the LearnUpon course, using the files in the `resources` subfolder when prompted.
